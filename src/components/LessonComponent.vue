    ...
    data() {
      return {
        lessons: [
          ...
          { title: "Tontechnik", tutor: "Paul Katzmayr", pic: "/pics/Tontechnik.png", text: "Die moderne Tontechnik ist vielfältig und vor allem für Musiker unumgänglich! Egal ob der richtige Schnitt von Audiofiles oder das Aufbauen einer PA-Anlage. Im Kurs Tontechnik geben wir einen kleinen Einblick in diese spannende Materie." },
