    ...
    data() {
      return {
        lessons: [
          ...
          { title: "Bewegtes Leben, bewegtes Lernen ", tutor: "Stefan Dollhäubl-Lehmann ", pic: "/pics2/Bewegtes Leben, bewegtes Lernen.jpg", text: "Ausgehend von Balance und Ausrichtung im Gegensatz zu einer Position, wird bewusstes Denken und Entscheiden in Bewegung vorgestellt und ausprobiert. Und was passiert im Körper, wenn wir uns bewegen – ein kurzer Theorieteil soll den auf Praxis ausgerichteten Kurs abrunden." },
          { title: "Schach", tutor: "Philipp Türkis", pic: "/pics2/Schach.jpg", text: "Das “Spiel der Könige” fördert strategisches Geschick und logisches Denken. Neben der Besprechung der Grundlagen, Regeln und einigen Tricks und Hilfestellungen wird auch Zeit für Schachspiele im Kurs sein." },
          { title: "Spanisch", tutor: "Ivana Glavas", pic: "/pics2/Spanisch.jpg", text: "¡Hablamos español! Tauche ein in die spanischsprachige Welt – nicht nur sprachlich, sondern auch kulturell – und gewinne neue Eindrücke von Spanien und Lateinamerika. ¡Vamos!  " },
          { title: "Chirurgisches Nähen", tutor: "Ursula Jahn", pic: "/pics2/Chirurgisches Nähen.jpg", text: "Größere Verletzungen der Haut verheilen schneller, wenn zusammengehörige Wundschichten spannungsfrei aneinander liegen. Hierbei kommt das chirurgische Nähen zum Einsatz, um die Wundheilung zu begünstigen. In diesem Kurs beschäftigen wir uns näher mit dem Aufbau der Haut und probieren verschiedene Naht- und Knotentechniken für einen erfolgreichen Wundverschluss aus." },
          { title: "Philosophie", tutor: "Tina Schmid-Ratzenböck", pic: "/pics2/Sofies-Welt.jpg", text: "Mit Textauszügen aus dem Buch “Sophies Welt” von Jostein Gaarder werden wir uns spannende Einblicke in verschiedene Gebiete der Philosophie erarbeiten. Ziel ist, dass schon Jugendliche Interesse an philosophischen Themen entwickeln und die Philosophie nicht als abgehobenes, abstraktes Fach sehen. " },
          { title: "Englisch", tutor: "Sandra Kiendler", pic: "/pics2/Gaming_English.jpg", text: "Game on! – oder doch Game Over? Bist du der Protagonist deines Spiels oder bloß NPC? Lerne das faszinierende Universum des Gamings kennen und die Sprache, die du brauchst, um dich in der komplexen Welt der Spiele – online und offline – zurechtzufinden." },
          { title: "Spieleprogrammierung", tutor: "Stefan Leutgeb", pic: "/pics2/gamerzone.jpg", text: "Du interessierst dich für Computerspiele und hast dich schon gefragt, wie man diese selbst erstellen kann? Dann bist du hier genau richtig! Wir werden in diesem Kurs kleine Spiele mit der Programmierumgebung Scratch entwickeln." },
          { title: "Chor", tutor: "Stefan Kapeller", pic: "/pics2/Chor.jpg", text: "Be part of the sound – du singst gerne und hast schon musikalische Erfahrung gesammelt? Dann bist du beim Jugendchor genau richtig. Wir singen alles, was uns Spaß macht, einstimmig & mehrstimmig, mit & ohne Klavier, von Abba bis Zappa. Mindestteilnehmerzahl: 8" },
          ...
          { title: "Tontechnik", tutor: "Paul Katzmayr", pic: "/pics2/Tontechnik.jpg", text: "Die moderne Tontechnik ist vielfältig und vor allem für Musiker unumgänglich! Egal ob der richtige Schnitt von Audiofiles oder das Aufbauen einer PA-Anlage. Im Kurs Tontechnik geben wir einen kleinen Einblick in diese spannende Materie." },
